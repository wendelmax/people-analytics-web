  ...
  return (
    <Layout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Meu Registro de Ponto</h1>
          <p className="text-gray-600">Registre sua entrada e saída, e acompanhe seu histórico de trabalho</p>
        </div>
